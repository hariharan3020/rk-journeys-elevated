        ...
        <div className="container-x">
          <div className="relative grid gap-10 lg:grid-cols-[1.05fr_1fr] items-center">
            <div className="relative z-10 fade-up">
              <span className="eyebrow">Trusted for 20 Years</span>
              <h1 className="mt-4 font-display font-bold text-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.02]">
